...
For styling the mobile app i have used Semantic UI (it is a development framework that helps create beautiful, responsive layouts using human-friendly HTML)

The react basic concept that i have used here like JSX, components, state, and props, react-router-dom, useState, useEffect and many more 
